...
- Full rationale: `docs/_INSTRUCTIONS.md` (Patches 17–19 launch/pin history; 50 daemon; 52–54 vendor-sync/brain/adoptions; 55 dual learning loop; 56–59 setup/proof + CI truthfulness; 60–61 daemon channel #3 + statusline truth). Run `bin/ruflo-kit status <target>` for a quick check or `bin/ruflo-kit session <target>` for the full per-session verify.
