...
- **Current global versions:** ruflo **v3.32.8**, agentic-qe **3.12.2** (as of 2026-07-19; ruflo drifted 3.32.7→3.32.8 between sessions — kit sentinels survived, now probe-verified). aqe 3.12.2 migrations (`qe_trajectories.metadata_json` + `qe_pattern_nulls`) applied; ~530 trajectories intact (point-in-time).
